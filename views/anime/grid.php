<?php
  ...
  $params['predictions'] = isset($params['predictions']) ? $params['predictions'] : array();
?>
...
?>
  <li>
    <?php echo $anime->link("show", "<h4>".escape_output($anime->title)."</h4>", Null, True, array('title' => $anime->title, 'data-toggle' => 'tooltip')); ?>
    <?php echo $anime->link("show", $anime->imageTag, Null, True, array('title' => $anime->description, 'data-toggle' => 'tooltip', 'data-placement' => 'right')); ?>
