...
<html lang="en">
  <head>
    ...
    <link href='<?php echo Config::ROOT_URL; ?>/css/animurecs.css?v=0.5' rel='stylesheet' />
    ...
    <script src='<?php echo Config::ROOT_URL; ?>/js/animurecs.js?v=0.5' type='text/javascript'></script>
  </head>
  <body>
