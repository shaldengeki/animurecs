...
<html xmlns='http://www.w3.org/1999/xhtml' xml:lang='en' lang='en'>
  <head>
    ...
    <script src='<?php echo Config::ROOT_URL; ?>/js/jquery.dataTables.min.js' type='text/javascript'></script>
    ...
    <script src='<?php echo Config::ROOT_URL; ?>/js/d3.v2.min.js' type='text/javascript'></script>
    <script src='<?php echo Config::ROOT_URL; ?>/js/d3-helpers.js' type='text/javascript'></script>

    <script src='<?php echo Config::ROOT_URL; ?>/js/bootstrap.min.js' type='text/javascript'></script>
