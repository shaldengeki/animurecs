    ...
    <div class='landing'>
      ...
      <div class="row-fluid landing-container">
        <div class="landing-box">
          ...
          <?php echo $firstUser->link('show', "<img src='img/animurecs-feed-comment.png' />", Null, True); ?>
        </div>
        <div class="landing-box">
          <p class='lead'>Get great recommendations. Without having to dig through mountains of shows you won't like.</p>
          <?php echo $firstUser->link('discover', "<img src='img/animurecs-anime-recommendations.png' />", Null, True); ?>
        </div>
        <div class="landing-box">
          <p class='lead'>Stay current with friends. Find and join groupwatches effortlessly.</p>
          <?php echo $firstUser->link('discover#groupwatches', "<img src='img/animurecs-groupwatches.png' />", Null, True); ?>
        </div>
      </div>
      <div class='row-fluid landing-container'>
